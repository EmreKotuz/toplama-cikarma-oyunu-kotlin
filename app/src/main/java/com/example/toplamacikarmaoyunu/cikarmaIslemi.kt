...
class cikarmaIslemi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (rastgeleList == 1) {
            ...
            val randomlar = Random.nextInt(-40, 40)
            ...
            val randomlarIki = Random.nextInt(-40, 40)
            ...
            val randomlarUc = Random.nextInt(-40, 40)
    ...
    private fun fonksiyondegisken() {
        reklamSayımı++
        val progressBar = findViewById<ProgressBar>(R.id.progressBar2)
        val view = View.inflate(this@cikarmaIslemi, R.layout.yildiz, null)
        val builder = AlertDialog.Builder(this@cikarmaIslemi)
    ...
    private fun eksiElli() {
        ...
        val view = View.inflate(this@cikarmaIslemi, R.layout.kybttin, null)
        val builder = AlertDialog.Builder(this@cikarmaIslemi)
        builder.setView(view)
